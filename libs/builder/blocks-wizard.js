...
Vvveb.BlocksGroup['Wizard'] = [
    "wizard/product-card",
    "wizard/user-online",
];


Vvveb.Blocks.add("wizard/product-card", {
    name: "Product Cards with Transition",
    image: "https://useagencyai-bucket.s3.us-west-1.amazonaws.com/editor/assets/imageonline-co-textimage.png",
    html: `
<div class="container">
...
Vvveb.Blocks.add("wizard/user-online", {
    name: "User online",
